...
// DailyTask is a paid mutator transaction binding the contract method 0xcddf90fe.
//
// Solidity: function dailyTask(uint256 start, uint256 end) returns(bool)
func (_City *CityTransactor) DailyTask(opts *bind.TransactOpts, start *big.Int, end *big.Int) (*types.Transaction, error) {
	return _City.contract.Transact(opts, "dailyTask", start, end)
}

// DailyTask is a paid mutator transaction binding the contract method 0xcddf90fe.
//
// Solidity: function dailyTask(uint256 start, uint256 end) returns(bool)
func (_City *CitySession) DailyTask(start *big.Int, end *big.Int) (*types.Transaction, error) {
	return _City.Contract.DailyTask(&_City.TransactOpts, start, end)
}

// DailyTask is a paid mutator transaction binding the contract method 0xcddf90fe.
//
// Solidity: function dailyTask(uint256 start, uint256 end) returns(bool)
func (_City *CityTransactorSession) DailyTask(start *big.Int, end *big.Int) (*types.Transaction, error) {
	return _City.Contract.DailyTask(&_City.TransactOpts, start, end)
}
