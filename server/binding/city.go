...
func (_City *CityCaller) GetAllCityNumber(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _City.contract.Call(opts, &out, "getAllCityNumber")
...
//
// Solidity: function getAllCityNumber() view returns(uint256)
func (_City *CitySession) GetAllCityNumber() (*big.Int, error) {
	return _City.Contract.GetAllCityNumber(&_City.CallOpts)
}

// GetAllCityNumber is a free data retrieval call binding the contract method 0x957466c7.
//
// Solidity: function getAllCityNumber() view returns(uint256)
func (_City *CityCallerSession) GetAllCityNumber() (*big.Int, error) {
	return _City.Contract.GetAllCityNumber(&_City.CallOpts)
}
