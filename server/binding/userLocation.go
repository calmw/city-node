...
//
// Solidity: function SetCityMapping(bytes32 countyId, bytes32 chengShiId, string location_) returns()
...
//
// Solidity: function setUserLocationV2(bytes32 countyId_, bytes32 cityId_, string location_) returns()
func (_UserLocation *UserLocationTransactor) SetUserLocationV2(opts *bind.TransactOpts, countyId_ [32]byte, cityId_ [32]byte, location_ string) (*types.Transaction, error) {
	return _UserLocation.contract.Transact(opts, "setUserLocationV2", countyId_, cityId_, location_)
}

// SetUserLocationV2 is a paid mutator transaction binding the contract method 0x53b8f664.
//
// Solidity: function setUserLocationV2(bytes32 countyId_, bytes32 cityId_, string location_) returns()
func (_UserLocation *UserLocationSession) SetUserLocationV2(countyId_ [32]byte, cityId_ [32]byte, location_ string) (*types.Transaction, error) {
	return _UserLocation.Contract.SetUserLocationV2(&_UserLocation.TransactOpts, countyId_, cityId_, location_)
}

// SetUserLocationV2 is a paid mutator transaction binding the contract method 0x53b8f664.
//
// Solidity: function setUserLocationV2(bytes32 countyId_, bytes32 cityId_, string location_) returns()
func (_UserLocation *UserLocationTransactorSession) SetUserLocationV2(countyId_ [32]byte, cityId_ [32]byte, location_ string) (*types.Transaction, error) {
	return _UserLocation.Contract.SetUserLocationV2(&_UserLocation.TransactOpts, countyId_, cityId_, location_)
}
