...
// SetCityMappingBatch is a paid mutator transaction binding the contract method 0x12adcb55.
//
// Solidity: function SetCityMappingBatch(bytes32[] countyIds, bytes32[] chengShiIds) returns()
func (_UserLocation *UserLocationTransactor) SetCityMappingBatch(opts *bind.TransactOpts, countyIds [][32]byte, chengShiIds [][32]byte) (*types.Transaction, error) {
	return _UserLocation.contract.Transact(opts, "SetCityMappingBatch", countyIds, chengShiIds)
}

// SetCityMappingBatch is a paid mutator transaction binding the contract method 0x12adcb55.
//
// Solidity: function SetCityMappingBatch(bytes32[] countyIds, bytes32[] chengShiIds) returns()
func (_UserLocation *UserLocationSession) SetCityMappingBatch(countyIds [][32]byte, chengShiIds [][32]byte) (*types.Transaction, error) {
	return _UserLocation.Contract.SetCityMappingBatch(&_UserLocation.TransactOpts, countyIds, chengShiIds)
}

// SetCityMappingBatch is a paid mutator transaction binding the contract method 0x12adcb55.
//
// Solidity: function SetCityMappingBatch(bytes32[] countyIds, bytes32[] chengShiIds) returns()
func (_UserLocation *UserLocationTransactorSession) SetCityMappingBatch(countyIds [][32]byte, chengShiIds [][32]byte) (*types.Transaction, error) {
	return _UserLocation.Contract.SetCityMappingBatch(&_UserLocation.TransactOpts, countyIds, chengShiIds)
}
