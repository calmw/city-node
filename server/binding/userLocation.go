...
// CountyIdInChengShiId is a free data retrieval call binding the contract method 0x1ea98e3e.
//
// Solidity: function countyIdInChengShiId(bytes32 countyId, bytes32 chengShiId) view returns(bool)
func (_UserLocation *UserLocationCaller) CountyIdInChengShiId(opts *bind.CallOpts, countyId [32]byte, chengShiId [32]byte) (bool, error) {
	var out []interface{}
	err := _UserLocation.contract.Call(opts, &out, "countyIdInChengShiId", countyId, chengShiId)
...
//
// Solidity: function countyIdInChengShiId(bytes32 countyId, bytes32 chengShiId) view returns(bool)
func (_UserLocation *UserLocationSession) CountyIdInChengShiId(countyId [32]byte, chengShiId [32]byte) (bool, error) {
...
// SetCityMapping is a paid mutator transaction binding the contract method 0x85a190d4.
//
// Solidity: function SetCityMapping(bytes32 countyId, bytes32 chengShiId, string location_) returns(bool)
func (_UserLocation *UserLocationTransactor) SetCityMapping(opts *bind.TransactOpts, countyId [32]byte, chengShiId [32]byte, location_ string) (*types.Transaction, error) {
	return _UserLocation.contract.Transact(opts, "SetCityMapping", countyId, chengShiId, location_)
}

// SetCityMapping is a paid mutator transaction binding the contract method 0x85a190d4.
//
// Solidity: function SetCityMapping(bytes32 countyId, bytes32 chengShiId, string location_) returns(bool)
func (_UserLocation *UserLocationSession) SetCityMapping(countyId [32]byte, chengShiId [32]byte, location_ string) (*types.Transaction, error) {
	return _UserLocation.Contract.SetCityMapping(&_UserLocation.TransactOpts, countyId, chengShiId, location_)
}

// SetCityMapping is a paid mutator transaction binding the contract method 0x85a190d4.
//
// Solidity: function SetCityMapping(bytes32 countyId, bytes32 chengShiId, string location_) returns(bool)
func (_UserLocation *UserLocationTransactorSession) SetCityMapping(countyId [32]byte, chengShiId [32]byte, location_ string) (*types.Transaction, error) {
	return _UserLocation.Contract.SetCityMapping(&_UserLocation.TransactOpts, countyId, chengShiId, location_)
}

// SetCityMappingBatch is a paid mutator transaction binding the contract method 0xff6d11b4.
//
// Solidity: function SetCityMappingBatch(bytes32[] countyIds, bytes32[] chengShiIds, string[] locations_) returns()
func (_UserLocation *UserLocationTransactor) SetCityMappingBatch(opts *bind.TransactOpts, countyIds [][32]byte, chengShiIds [][32]byte, locations_ []string) (*types.Transaction, error) {
	return _UserLocation.contract.Transact(opts, "SetCityMappingBatch", countyIds, chengShiIds, locations_)
}

// SetCityMappingBatch is a paid mutator transaction binding the contract method 0xff6d11b4.
//
// Solidity: function SetCityMappingBatch(bytes32[] countyIds, bytes32[] chengShiIds, string[] locations_) returns()
func (_UserLocation *UserLocationSession) SetCityMappingBatch(countyIds [][32]byte, chengShiIds [][32]byte, locations_ []string) (*types.Transaction, error) {
	return _UserLocation.Contract.SetCityMappingBatch(&_UserLocation.TransactOpts, countyIds, chengShiIds, locations_)
}

// SetCityMappingBatch is a paid mutator transaction binding the contract method 0xff6d11b4.
//
// Solidity: function SetCityMappingBatch(bytes32[] countyIds, bytes32[] chengShiIds, string[] locations_) returns()
func (_UserLocation *UserLocationTransactorSession) SetCityMappingBatch(countyIds [][32]byte, chengShiIds [][32]byte, locations_ []string) (*types.Transaction, error) {
	return _UserLocation.Contract.SetCityMappingBatch(&_UserLocation.TransactOpts, countyIds, chengShiIds, locations_)
}

// SetCityMappingDel is a paid mutator transaction binding the contract method 0xee0707e7.
//
// Solidity: function SetCityMappingDel(bytes32 chengShiId, uint256 index) returns()
func (_UserLocation *UserLocationTransactor) SetCityMappingDel(opts *bind.TransactOpts, chengShiId [32]byte, index *big.Int) (*types.Transaction, error) {
	return _UserLocation.contract.Transact(opts, "SetCityMappingDel", chengShiId, index)
}

// SetCityMappingDel is a paid mutator transaction binding the contract method 0xee0707e7.
//
// Solidity: function SetCityMappingDel(bytes32 chengShiId, uint256 index) returns()
func (_UserLocation *UserLocationSession) SetCityMappingDel(chengShiId [32]byte, index *big.Int) (*types.Transaction, error) {
	return _UserLocation.Contract.SetCityMappingDel(&_UserLocation.TransactOpts, chengShiId, index)
}

// SetCityMappingDel is a paid mutator transaction binding the contract method 0xee0707e7.
//
// Solidity: function SetCityMappingDel(bytes32 chengShiId, uint256 index) returns()
func (_UserLocation *UserLocationTransactorSession) SetCityMappingDel(chengShiId [32]byte, index *big.Int) (*types.Transaction, error) {
	return _UserLocation.Contract.SetCityMappingDel(&_UserLocation.TransactOpts, chengShiId, index)
}
...
// SetUserLocationV2 is a paid mutator transaction binding the contract method 0x53b8f664.
//
// Solidity: function setUserLocationV2(bytes32 countyId_, bytes32 chengShiId_, string location_) returns()
func (_UserLocation *UserLocationTransactor) SetUserLocationV2(opts *bind.TransactOpts, countyId_ [32]byte, chengShiId_ [32]byte, location_ string) (*types.Transaction, error) {
	return _UserLocation.contract.Transact(opts, "setUserLocationV2", countyId_, chengShiId_, location_)
}

// SetUserLocationV2 is a paid mutator transaction binding the contract method 0x53b8f664.
//
// Solidity: function setUserLocationV2(bytes32 countyId_, bytes32 chengShiId_, string location_) returns()
func (_UserLocation *UserLocationSession) SetUserLocationV2(countyId_ [32]byte, chengShiId_ [32]byte, location_ string) (*types.Transaction, error) {
	return _UserLocation.Contract.SetUserLocationV2(&_UserLocation.TransactOpts, countyId_, chengShiId_, location_)
}

// SetUserLocationV2 is a paid mutator transaction binding the contract method 0x53b8f664.
//
// Solidity: function setUserLocationV2(bytes32 countyId_, bytes32 chengShiId_, string location_) returns()
func (_UserLocation *UserLocationTransactorSession) SetUserLocationV2(countyId_ [32]byte, chengShiId_ [32]byte, location_ string) (*types.Transaction, error) {
	return _UserLocation.Contract.SetUserLocationV2(&_UserLocation.TransactOpts, countyId_, chengShiId_, location_)
}
