...
// AdminSetAreaLevel is a paid mutator transaction binding the contract method 0x1b09b73a.
//
// Solidity: function adminSetAreaLevel(bytes32 AreaId_, uint256 level_) returns()
func (_City *CityTransactor) AdminSetAreaLevel(opts *bind.TransactOpts, AreaId_ [32]byte, level_ *big.Int) (*types.Transaction, error) {
	return _City.contract.Transact(opts, "adminSetAreaLevel", AreaId_, level_)
}

// AdminSetAreaLevel is a paid mutator transaction binding the contract method 0x1b09b73a.
//
// Solidity: function adminSetAreaLevel(bytes32 AreaId_, uint256 level_) returns()
func (_City *CitySession) AdminSetAreaLevel(AreaId_ [32]byte, level_ *big.Int) (*types.Transaction, error) {
	return _City.Contract.AdminSetAreaLevel(&_City.TransactOpts, AreaId_, level_)
}

// AdminSetAreaLevel is a paid mutator transaction binding the contract method 0x1b09b73a.
//
// Solidity: function adminSetAreaLevel(bytes32 AreaId_, uint256 level_) returns()
func (_City *CityTransactorSession) AdminSetAreaLevel(AreaId_ [32]byte, level_ *big.Int) (*types.Transaction, error) {
	return _City.Contract.AdminSetAreaLevel(&_City.TransactOpts, AreaId_, level_)
}
...
// AdminSetPioneer is a paid mutator transaction binding the contract method 0xc1ed775b.
//
// Solidity: function adminSetPioneer(bytes32 chengShiId_, address pioneer_, uint256 pioneerBatch_, uint256 pioneerType_) returns()
func (_City *CityTransactor) AdminSetPioneer(opts *bind.TransactOpts, chengShiId_ [32]byte, pioneer_ common.Address, pioneerBatch_ *big.Int, pioneerType_ *big.Int) (*types.Transaction, error) {
	return _City.contract.Transact(opts, "adminSetPioneer", chengShiId_, pioneer_, pioneerBatch_, pioneerType_)
}

// AdminSetPioneer is a paid mutator transaction binding the contract method 0xc1ed775b.
//
// Solidity: function adminSetPioneer(bytes32 chengShiId_, address pioneer_, uint256 pioneerBatch_, uint256 pioneerType_) returns()
func (_City *CitySession) AdminSetPioneer(chengShiId_ [32]byte, pioneer_ common.Address, pioneerBatch_ *big.Int, pioneerType_ *big.Int) (*types.Transaction, error) {
	return _City.Contract.AdminSetPioneer(&_City.TransactOpts, chengShiId_, pioneer_, pioneerBatch_, pioneerType_)
}

// AdminSetPioneer is a paid mutator transaction binding the contract method 0xc1ed775b.
//
// Solidity: function adminSetPioneer(bytes32 chengShiId_, address pioneer_, uint256 pioneerBatch_, uint256 pioneerType_) returns()
func (_City *CityTransactorSession) AdminSetPioneer(chengShiId_ [32]byte, pioneer_ common.Address, pioneerBatch_ *big.Int, pioneerType_ *big.Int) (*types.Transaction, error) {
	return _City.Contract.AdminSetPioneer(&_City.TransactOpts, chengShiId_, pioneer_, pioneerBatch_, pioneerType_)
}
